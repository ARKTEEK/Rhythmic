...
export default function DuplicateSearchPanel({
  ...
  return (
    <SidePanel
      ...
      onClose={onClose}>
      <div className="p-4 bg-[#fff5df] border-b-2 border-black flex items-center justify-between shrink-0">
        ...
        <div className="flex gap-3">
          <button
            disabled={isScanning}
            onClick={onStartScan}
            className="px-4 py-1 bg-[#63d079] hover:bg-[#4ec767] border-2 border-black box-style-md
          ...
          <button
            ...
            className="px-4 py-1 bg-[#f2b46b] hover:bg-[#e09f55] border-2 border-black box-style-md
                       uppercase font-bold flex items-center gap-1 text-sm cursor-pointer
                       disabled:cursor-not-allowed disabled:opacity-50">
        ...
        {sorted.map((t, i) => (
          <div
            ...
            <input
              ...
              onChange={() => toggle(t)}
              className="w-4 h-4 border-2 border-black mr-3 cursor-pointer"
            />
            ...
            <button
              ...
              className="p-1 bg-yellow-400 hover:bg-yellow-500 border-2 border-black box-style-sm ml-2 hover:cursor-pointer">
