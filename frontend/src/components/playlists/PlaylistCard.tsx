  ...
  return (
    ...
    >
      <div className="relative h-20 w-full overflow-hidden">
        ...
        />
        <div
          className={ `absolute top-2 left-2 px-2 py-1 rounded-full text-xs font-medium text-white shadow-md z-20 bg-red-600/80` }
        >
          { sourceText }
        </div>
      </div>
      ...
      <div
        className="p-4 flex flex-col gap-1 bg-gray-700/40 group-hover:bg-gray-600/50 transition-colors duration-300">
