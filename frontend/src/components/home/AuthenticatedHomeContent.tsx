...
const AuthenticatedHomeContent = () => {
  ...
  return (
    <div className="w-full max-w-lg mx-auto flex flex-col items-center text-center">
      ...
      {songs.length > 0 && (
        <div className="mt-6 w-full max-h-[400px] bg-transparent border-2 border-gray-700 p-4 overflow-y-auto scrollbar-thin scrollbar-thumb-red-600 scrollbar-track-gray-700 text-left">
