...
import { googleOAuth, spotifyOAuth } from "../../configs/Config.ts";
...
const ProfilePopup: React.FC<{ isOpen: boolean; onClose: () => void }> = ({
  ...
  return (
    <Dialog
      ...
      <DialogPanel
        className="relative bg-white/10 border border-white/30 shadow-2xl
        backdrop-blur-xl rounded-2xl w-full max-w-2xl p-6 text-white">
        <button
          onClick={ onClose }
        ...
        <div className="mb-10">
          ...
          <label className="block mb-4">
            ...
            <input
              type="text"
              className="w-full mt-1 rounded-lg bg-white/20 text-white px-4 py-2
        ...
        <div className="mb-10">
          ...
          <label className="block relative mb-4">
            ...
            <input
              ...
              className="w-full mt-1 rounded-lg bg-white/20 text-white px-4 py-2 pr-10
              focus:outline-none focus:ring-2 focus:ring-emerald-400"
              value={ password }
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <button
              ...
              transition text-white rounded-xl py-2 font-medium">
              <FaSpotify className="w-5 h-5"/>
              Connect Spotify
            </button>
            <button
              onClick={ googleOAuth }
              className="flex items-center justify-center gap-3 bg-red-500 hover:bg-red-600
              transition text-white rounded-xl py-2 font-medium">
