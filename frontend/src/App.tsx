  ...
  return (
    <div
      ...
      <div className="relative z-10 flex flex-col items-center text-center text-white p-6">
        ...
        <p className="text-gray-300 mt-2 text-lg">Your gateway to seamless playlist management</p>
        ...
        <p className="text-sm text-gray-400 mt-4">
          By signing in, you agree to our <a href={ "/terms" }
                                             className="text-red-400 hover:underline">Terms</a> and <a
          href={ "/policy" }
          className="text-red-400 hover:underline">Privacy Policy</a>
        </p>

        <a href="#" className="mt-6 text-gray-400 hover:text-gray-300 text-sm">
