...
public interface IScheduledJobService {
  Task<int> CreateScheduledJobAsync(string userId, string jobType, string targetType, int targetId, int intervalMinutes);
  ...
  Task RecordJobExecutionAsync(int scheduledJobId, string status, DateTime startedAt, DateTime? finishedAt = null, string? errorMessage = null, string? metadata = null);
}
