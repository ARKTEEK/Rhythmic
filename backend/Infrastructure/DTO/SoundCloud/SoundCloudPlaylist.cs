...
public class SoundCloudPlaylist {
  ...
  [JsonPropertyName("sharing")] public string Sharing { get; set; } = "public";
  ...
  [JsonPropertyName("user")] public SoundCloudUserResponse? User { get; set; }

  [JsonPropertyName("tracks")] public List<SoundCloudTrack> Tracks { get; set; } = new();
}
...
public class SoundCloudTrack {
  ...
  [JsonPropertyName("permalink_url")] public string PermalinkUrl { get; set; } = string.Empty;
...
public class SoundCloudCollectionResponse<T> {
  [JsonPropertyName("collection")] public List<T> Collection { get; set; } = new();
